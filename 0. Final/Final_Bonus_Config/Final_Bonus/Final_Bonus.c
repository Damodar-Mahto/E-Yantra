...
int main()
{
	...
	L1:	if((L<0x17 && C>0x17 && R<0x17))        // 010 
		...
		if((flag_S1==0) && (flag_Shape == 0) && ( rotation_z > 30 && rotation_z < 50 ) && (pathR > 18) && (node_count == 15) && run ==2)      //curve detection
		{
			flag_S1=1;
			flag_Shape=1;
			buzzer_beep();
		...
		else if((flag_S2==0) && ( force_x > 3000 && force_x < 4000 ) && (pathR > 20 && pathR < 30) && (node_count == 16 || node_count == 27) && run == 2 )    //bigger hump detector
		{
			flag_S2=1;
			flag_Shape=1;
			buzzer_beep();
